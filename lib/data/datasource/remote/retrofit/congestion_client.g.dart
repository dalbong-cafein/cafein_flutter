...
class _CongestionClient implements CongestionClient {
  _CongestionClient(this._dio, {this.baseUrl}) {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<int>>(
            Options(method: 'POST', headers: _headers, extra: _extra)
                .compose(_dio.options, '/congestion',
  ...
  Future<BaseResponse<CongestionResponse>> getCongestions(
      storeId, minusDays) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'minusDays': minusDays};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<CongestionResponse>>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, '/stores/${storeId}/congestion',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
