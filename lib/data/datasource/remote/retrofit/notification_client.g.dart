...
class _NotificationClient implements NotificationClient {
  ...
  Future<BaseResponse<List<Notification>>> getNotices() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<List<Notification>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<BaseResponse<dynamic>> deleteAllNotice() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<BaseResponse<ReportNotification>> getReportNotification(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<ReportNotification>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/notices/reportType/${noticeId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = BaseResponse<ReportNotification>.fromJson(
      _result.data!,
      (json) => ReportNotification.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
