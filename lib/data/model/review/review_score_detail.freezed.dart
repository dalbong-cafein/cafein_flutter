...
ReviewDetailScore _$ReviewDetailScoreFromJson(Map<String, dynamic> json) {
  return _ReviewDetailScore.fromJson(json);
}
...
mixin _$ReviewDetailScore {
  ...
  @JsonKey(ignore: true)
  $ReviewDetailScoreCopyWith<ReviewDetailScore> get copyWith =>
...
/// @nodoc
abstract class _$$_ReviewDetailScoreCopyWith<$Res>
    implements $ReviewDetailScoreCopyWith<$Res> {
  factory _$$_ReviewDetailScoreCopyWith(_$_ReviewDetailScore value,
...
class _$_ReviewDetailScore implements _ReviewDetailScore {
  _$_ReviewDetailScore(
      ...
      required this.wifi,
      required this.wifiCnt,
      required this.restroom,
      required this.restroomCnt,
      required this.tableSize,
      required this.tableCnt});

  factory _$_ReviewDetailScore.fromJson(Map<String, dynamic> json) =>
      _$$_ReviewDetailScoreFromJson(json);
  ...
  @override
  String toString() {
    return 'ReviewDetailScore(reviewCnt: $reviewCnt, recommendPercent: $recommendPercent, socket: $socket, socketCnt: $socketCnt, wifi: $wifi, wifiCnt: $wifiCnt, restroom: $restroom, restroomCnt: $restroomCnt, tableSize: $tableSize, tableCnt: $tableCnt)';
  }
...
abstract class _ReviewDetailScore implements ReviewDetailScore {
  factory _ReviewDetailScore(
      ...
      required final int wifiCnt,
      required final String restroom,
      required final int restroomCnt,
      required final String tableSize,
      required final int tableCnt}) = _$_ReviewDetailScore;

  factory _ReviewDetailScore.fromJson(Map<String, dynamic> json) =
