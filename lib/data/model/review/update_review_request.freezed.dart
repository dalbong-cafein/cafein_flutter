...
/// @nodoc
abstract class _$$_UpdateReviewRequestCopyWith<$Res>
    implements $UpdateReviewRequestCopyWith<$Res> {
  factory _$$_UpdateReviewRequestCopyWith(_$_UpdateReviewRequest value,
...
class _$_UpdateReviewRequest implements _UpdateReviewRequest {
  _$_UpdateReviewRequest(
      ...
      final List<String>? updateImageFiles,
  ...
  @override
  String toString() {
    return 'UpdateReviewRequest(reviewId: $reviewId, recommendation: $recommendation, content: $content, socket: $socket, wifi: $wifi, restroom: $restroom, tableSize: $tableSize, updateImageFiles: $updateImageFiles, deleteImageIds: $deleteImageIds)';
  }
