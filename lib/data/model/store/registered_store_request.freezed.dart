...
part of 'registered_store_request.dart';
...
/// @nodoc
mixin _$RegisteredStoreRequest {
  ...
  @JsonKey(ignore: true)
  $RegisteredStoreRequestCopyWith<RegisteredStoreRequest> get copyWith =>
...
/// @nodoc
abstract class _$$_RegisteredStoreRequestCopyWith<$Res>
    implements $RegisteredStoreRequestCopyWith<$Res> {
  factory _$$_RegisteredStoreRequestCopyWith(_$_RegisteredStoreRequest value,
...
class _$_RegisteredStoreRequest implements _RegisteredStoreRequest {
  ...
  @override
  String toString() {
    return 'RegisteredStoreRequest(storeName: $storeName, addressInfo: $addressInfo, phoneNumber: $phoneNumber, wifiPassword: $wifiPassword, webSite: $webSite, lngX: $lngX, latY: $latY, imageFiles: $imageFiles, totalBusinessInfo: $totalBusinessInfo, recommendation: $recommendation, socket: $socket, wifi: $wifi, restroom: $restroom, tableSize: $tableSize)';
  }
...
abstract class _RegisteredStoreRequest implements RegisteredStoreRequest {
  factory _RegisteredStoreRequest(
