...
class ApplyCouponBloc extends Bloc<ApplyCouponEvent, ApplyCouponState> {
  ...
  FutureOr<void> _onCouponClicked(CouponClicked event, Emitter<ApplyCouponState> emit) async {
  ...
  FutureOr<void> _onCouponReClicked(CouponReClicked event, Emitter<ApplyCouponState> emit) async {
