...
class ReceivedCouponsBloc
    extends Bloc<ReceivedCouponsEvent, ReceivedCouponsState> {
  ReceivedCouponsBloc({required this.couponRepository}) : super(const ReceivedCouponsInitial()) {
  ...
  FutureOr<void> _onReceivedCouponsRequested(
      ReceivedCouponsRequested event,
      Emitter<ReceivedCouponsState> emit) async {
